...
# books[order(books$Corpus_Gephi_File_Name),]
```

```{r}
corpus <- list.files("~/Downloads/Hewins/corpus", full.names = T)
...
write_xlsx(data.frame(all_words),"Hewins_words_per_book_separated_nostem/book1_words.xlsx")
...
for (i in 2:100){
  ...
  # name = "Hewins_words_per_book_separated_nostem/book{i}_words.xlsx"
  name = paste0("Hewins_words_per_book_separated_nostem/book", i, "_words.xlsx")
  write_xlsx(data.frame(all_words), name)
}
```
...
write_xlsx(data.frame(all_words),"Hewins_words_per_book_separated_nostem/book101_words.xlsx")
...
write_xlsx(data.frame(all_words),"Hewins_words_per_book_separated_nostem/book201_words.xlsx")
...
write_xlsx(data.frame(all_words),"Hewins_words_per_book_separated_nostem/book301_words.xlsx")
